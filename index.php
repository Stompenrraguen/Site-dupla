...
<header class="topo">
    ...
    <div class="area-login">
        <?php if (!empty($_SESSION["logado"])): ?>
            ...
            <a href="logout.php" class="botao-secundario">
                Sair
            </a>
        <?php else: ?>
            <a href="login.php" class="botao-secundario">
                Login
            </a>
        <?php endif; ?>
    </div>
...
<section class="barra-busca">
    <form action="index.php" method="POST">
        <input
            type="text"
            name="busca_campo"
            placeholder="Pesquisar jogos na loja"
            value="<?= htmlspecialchars($busca) ?>"
        >

        <button type="submit" name="b_busca">
            Pesquisar
        </button>
    </form>
</section>
...
<section class="chamada">
    <div>
        ...
        <p>
            Escolha seu jogo, adicione ao carrinho, faça login e
            confirme sua compra com praticidade.
        </p>
    </div>
</section>
...
<footer>
    ...
    <div>
        <p>
            ...
            Kaio Carvalho, Enzo Daniel e equipe.
        </p>
    </div>
</footer>
